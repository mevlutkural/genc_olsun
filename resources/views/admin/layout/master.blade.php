...
<head>
    <!--  Title -->
    <title>@yield('title', 'Panel') | Genç Olsun</title>
    <!--  Required Meta Tag -->
            ...
            <ul class="mb-0">
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/products/product-1.jpg"
                            width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
                        <div>
                ...
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/products/product-2.jpg"
                            width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
                        <div>
                            <h6 class="mb-1">Supreme toys cooker</h6>
                            <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                ...
                <li class="pb-7">
                    <div class="d-flex align-items-center">
                        <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/products/product-3.jpg"
                            width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="" />
                        <div>
                            <h6 class="mb-1">Supreme toys cooker</h6>
                            <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse first-level my-3">
                            ...
                            <ul class="px-8 mt-7 mb-4">
                                ...
                                <li class="sidebar-item py-2">
                                    <a class="fw-semibold text-dark" href="index.html#">Pricing Page</a>
                                </li>
                                <li class="sidebar-item py-2">
                                    <a class="fw-semibold text-dark" href="index.html#">Authentication Design</a>
                                </li>
                                <li class="sidebar-item py-2">
                                    <a class="fw-semibold text-dark" href="index.html#">Register Now</a>
                                </li>
                                <li class="sidebar-item py-2">
                                    <a class="fw-semibold text-dark" href="index.html#">404 Error Page</a>
                                </li>
                                <li class="sidebar-item py-2">
                                    <a class="fw-semibold text-dark" href="index.html#">Notes App</a>
                                </li>
                                <li class="sidebar-item py-2">
                                    <a class="fw-semibold text-dark" href="index.html#">User Application</a>
                                </li>
                                <li class="sidebar-item py-2">
                                    <a class="fw-semibold text-dark" href="index.html#">Account Settings</a>
                                </li>
                            </ul>
                        </ul>
                    </li>
