...
@section('title', 'İş İlanı Oluştur')
@section('content')
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <div>
                        <ul class="nav">
                            <li class="nav-item">
                                <a href="{{ route('job-posts.index') }}" class="text-dark fs-4">İş İlanları</a>
                            </li>
                            <li class="nav-item ms-1">
                                <span class="fs-4">{{ '>' }}</span>
                            </li>
                            <li class="nav-item ms-1 text-primary">
                                <span class="fs-4"> İş İlanı Oluştur</span>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="card-body">
                <form id="internshipPostForm" action="{{ route('job-posts.store') }}" method="POST"
