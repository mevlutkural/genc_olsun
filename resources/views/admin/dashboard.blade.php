            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="index.html#" class="bg-light rounded py-1 px-8 d-flex align-items-center">
            ...
            <div class="card bg-primary border-0 w-100">
                <div class="card-body pb-0">
                    ...
                    <div class="text-center mt-3">
                        <img src="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/dist/images/backgrounds/piggy.png"
                            class="img-fluid" alt="" />
                    </div>
                </div>
