        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('scholarship-posts.create') }}" class="btn btn-outline-primary">
                                        ...
                                        <ul class="nav">
                                            <li class="nav-item ms-2">
                                                <button class="btn btn-danger"
                                                    data-target="{{ route('scholarship-posts.destroy', $post->scholarship_post_id) }}"
