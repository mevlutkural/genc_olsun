...
@section('content')
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <div>
                        <ul class="nav">
                            <li class="nav-item">
                                <a href="{{ route('activities-posts.index') }}" class="text-dark fs-4">Etkinlikler</a>
                            </li>
                            <li class="nav-item ms-1">
                                <span class="fs-4">{{ '>' }}</span>
                            </li>
                            <li class="nav-item ms-1 text-primary">
                                <span class="fs-4"> Etkinlik Oluştur</span>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="card-body">
                <form id="internshipPostForm" action="{{ route('activities-posts.store') }}" method="POST"
