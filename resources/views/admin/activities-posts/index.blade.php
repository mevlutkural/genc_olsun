        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('activities-posts.create') }}" class="btn btn-outline-primary">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="jobsTable" class="table">
                        ...
                        <tbody>
                            @if ($activitiesPosts->count() > 0)
                                @foreach ($activitiesPosts as $post)
                                    <tr>
                                        <td>
                                            <div>
                                            ...
                                            <ul class="nav">
                                                <li class="nav-item ms-2">
                                                    <button class="btn btn-danger"
                                                        data-target="{{ route('activities-posts.destroy', $post->activities_post_id) }}"
