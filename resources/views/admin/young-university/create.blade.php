...
@section('title', 'Genç Üniversiteli Oluştur')
@section('content')
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <div>
                        <ul class="nav">
                            <li class="nav-item">
                                <a href="{{ route('young-university.index') }}" class="text-dark fs-4">Genç
                                    Üniversiteliler</a>
                            </li>
                            ...
                            <li class="nav-item ms-1 text-primary">
                                <span class="fs-4">Genç Üniversiteli Oluştur</span>
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="card-body">
                <form id="internshipPostForm" action="{{ route('young-university.store') }}" method="POST"
